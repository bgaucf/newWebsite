        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6">
          ...
          <div className="space-y-4 mb-16">
            {recurringCompetitions.map((comp, i) => (
              <div
                key={i}
                className="flex items-center gap-4 p-4 rounded-xl bg-gray-50 border border-gray-200 hover:border-gold/50 transition-colors"
              >
          ...
          <div className="space-y-6">
            {previousCompetitions.map((comp, i) => (
              <div
                key={i}
                className="p-6 rounded-xl bg-gray-50 border border-gray-200 hover:border-gold/50 transition-colors"
              >
